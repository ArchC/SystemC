...
void mcast_pkt_switch :: entry()
{
  ...
  cout << "--------------------------------------------------------------------------------------" << endl;
  cout << "  This is the simulation of a  4x4 non-blocking multicast helix packet switch. The" << endl; 
  cout << "  switch uses a self-routing ring  of shift registers  to  transfer cells from one" << endl;
  cout << "  port to another in a pipelined fashion, resolving output contention and handling" << endl;
  cout << "  multicast switch efficiently." << endl << endl;
