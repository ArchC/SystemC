...
//******************************************************************************
class isdb_sc_bit_trace : public isdb_trace {
public:
...
isdb_sc_bit_trace::isdb_sc_bit_trace(const sc_bit& object, const sc_string& name,
  const sc_string& isdb_name): isdb_trace(name, isdb_name), object(object)
{
    isdb_var_typ_name = "wire";
    bit_width = 1;
    old_value = object;
...
isdb_sc_uint_base_trace::isdb_sc_uint_base_trace(const sc_uint_base& _object, const sc_string& _name, const sc_string& _isdb_name) 
  : isdb_trace(_name, _isdb_name), object(_object), old_value(_object.bitwidth()) // The last may look strange, but is correct
{
    isdb_var_typ_name = "wire";
    old_value = object;
}
...
isdb_sc_int_base_trace::isdb_sc_int_base_trace(const sc_int_base& _object, const sc_string& _name, const sc_string& _isdb_name) 
  : isdb_trace(_name, _isdb_name), object(_object), old_value(_object.bitwidth())
{
    isdb_var_typ_name = "wire";
    old_value = object;
}
...
void isdb_trace_file::trace(const sc_signal_resolved_vector& object, const sc_string& name)
{
    ...
    sc_string temp_isdb_name;
    create_isdb_name(&temp_isdb_name);
    traces.push_back(new isdb_sc_logic_vector_trace(reinterpret_cast<const sc_logic_vector&>(object), name, temp_isdb_name));
}
