...
sc_lambda::eval() const
{
    ...
    default:
        REPORT_WARNING(1014,
          sc_string::to_string("sc_lambda::eval(): %lx",int(rator_ty)).c_str());
        return false;
    }
}
...
sc_lambda::int_eval() const
{
    ...
    default:
        REPORT_WARNING(1015,
          sc_string::to_string("sc_lambda::int_eval(): %lx",int(rator_ty)).c_str());
        return 0;
    }
}
...
sc_lambda::sc_logic_eval() const
{
    ...
    default:
        REPORT_WARNING(1016,
          sc_string::to_string("sc_lambda::sc_logic_eval(): %lx",int(rator_ty)).c_str());
        return sc_logic();
    }
}
